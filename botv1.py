...
def _send_data_backup_to_admins(reason: str = "Shutdown"):
    ...
    try:
        ...
        with open(CONFIG_FILE, "r", encoding="utf-8") as _cf:
            _cfg = json.load(_cf)
        _tok  = _cfg.get("8798199854:AAG8h9eb-Axx6A9AfwqI685nuSZs1EYLOIk", "")
        _aids = _cfg.get("8597996592", [])
...
# ════════════════════════════════════════════
DEFAULT_CONFIG = {
    "bot_token":          "Y8798199854:AAG8h9eb-Axx6A9AfwqI685nuSZs1EYLOIk",
    "admin_ids":          [],
    "channel_username":   "walaeh",
    "locked":             False,
    "global_limit":       None,
    "vip_limit":          None,
...
def is_admin(uid: int, cfg: dict) -> bool:
    return uid in cfg.get("8597996592",[])
